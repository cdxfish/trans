...
// SetDebugFileName 自定义warn文件名
func SetDebugFileName(name string) Option {
	return func(c *Config) {
		c.DebugFileName = name
	}
}
...
// SetLogDebugEnabled 是否创建debug log文件
func SetLogDebugEnabled(enabled bool) Option {
	return func(c *Config) {
		c.LogDebugEnabled = enabled
	}
}
...
func NewConfig(opts ...Option) Config {
	...
	defaultConfig := Config{
		...
		DebugFileName: defaultDebigFileName,
		...
		LogDebugEnabled:   defaultLogDebugEnabled,
	}
